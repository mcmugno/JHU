...
function buildAndShowAboutHTML (categories) {
  ...
  $ajaxUtils.sendGetRequest(
    ...
    function (aboutHtml) {
      ...
      var numberOfStars = randomRating();
      console.log(numberOfStars);

      var aboutHtmlToInsertIntoMainPage = "";

      // display the random number of stars
      for(var i = 1; i <= numberOfStars; i++){
        var starProp = "starProp" + i;
        aboutHtmlToInsertIntoMainPage += insertProperty(aboutHtml, starProp, "fa fa-star");
      }

      for(var i = numberOfStars; i < 5; i++){
        var starProp = "starProp" + i;
        aboutHtmlToInsertIntoMainPage += insertProperty(aboutHtml, starProp, "fa fa-star-o");
      }

      aboutHtmlToInsertIntoMainPage += numberOfStars + "-star rating";
